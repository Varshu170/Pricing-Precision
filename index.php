...
<body>
    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php"><b>Pricing System</b></a>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        <h1>Utility Pricing System</h1>
                   <p>The Utility wanted to rebuild its pricing system to enhance accuracy,flexibility and the customer experience by consolidating its application and building a new content management system(CMS)</p>

					   <p>This website at the end of its construction will act as a consumer oriented service for users for easy Price of their respective <b>Electricity Price</b> as well as interact with their providers in case of any queries or grivances.</p>
                    </div>
                    <!-- /col-lg-6 -->
                    <div class="col-lg-6">
                        <h1 styles="font-size:15px;">Industrial Customer Sign Up</h1>
    ...
    <div class="container">
        ...
        <div class="row mt centered">
            <div class="col-lg-4">
                <img src="assets/img/1.jpg" width="180" alt="">
                <h4>1 - Login</h4>
                <p></p>
            </div>
            <!--/col-lg-4 -->
            ...
            <div class="col-lg-4">
                <img src="assets/img/2.jpg" width="180" alt="">
                <h4>2 - Peruse Pricing</h4>
                <p></p>
            </div>
            <!--/col-lg-4 -->

            <div class="col-lg-4">
                <img src="assets/img/3.jpg" width="180" alt="">
                <h4>3 - Transact</h4>
                <p></p>
            </div>
            <!--/col-lg-4 -->
