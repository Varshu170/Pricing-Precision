...
if(isset($_POST["reg_submit"])) {
		...
		$utility = test_input($_POST['utility']);
        ...
        if($flag == 0)
        {
            ...
            $sql = "INSERT INTO user (`name`,`email`,`phone`,`pass`,`address`,usertype,utility)
                    VALUES('$name','$email','$contactNo','$password','$address','$usertype','$utility')";
                    //echo $sql;
    ...
    window.alert('Customer Registration Successfully');
    window.location.href='index.php';
    </script>");
			
			 //echo '<script type="text/javascript">alert("User Successfully Registration!");</script>';
...
<center>
    ...
    <div class="form-group">
	 ...
	 <div class="form-group">
        <div class="col-md-12">
            <Select  class="form-control" name="usertype" required><option>Home User</open><option>Business User</open><select>
            <!-- <label><?php echo $phoneErr;?></label> -->
        </div>
    </div>
	...
	<div class="form-group">
        <div class="col-md-12">
            <Select  class="form-control" name="utility" required><option>Electricity</open><option>Gas</open><option>Water</open><select>
            <!-- <label><?php echo $phoneErr;?></label> -->
        </div>
    </div>
